...
send!(send_bool_id_id_id, bool, (a: Id, b: Id, c: Id));
send!(send_u64, UInteger, ());
send!(send_i64, Integer, ());
send!(send_f64, f64, ());
send!(send_id_f64_f64, Id, (a: f64, b: f64));
send!(send_rect, Rect, ());
send!(send_size, Size, ());
send!(send_id_i64, Id, (a: Integer));
send!(send_id_i64_i64_bool, Id, (a: Integer, b: Integer, c: bool));
send!(send_bool_id_i64, bool, (a: Id, b: Integer));
